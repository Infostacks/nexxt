...
import { requiredSkills } from "../../utils/data";
import React from "react";

const RequiredSkills = ({ formStep, nextFormStep }: any) => {
  ...
  return (
    <div
      className={`${formStep === 7 ? "block" : "hidden"} flex flex-col gap-10 `}
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
            ...
            return (
              <div className="relative" key={index}>
                ...
                <label
                  ...
                  htmlFor={skill.icon}
                >
                  <img src={skill.icon} alt="" width="35" height="35" />
        ...
        <div className="flex flex-row-reverse">
          <button
            className="text-xl font-bold bg-secondary shadow-lg shadow-secondary py-3 px-5 rounded-xl drop-shadow-md mt-8"
            type="submit"
          >
            Next
          </button>
