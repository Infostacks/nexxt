...
const TypeOfDeveloper = ({ formStep, nextFormStep }: any) => {
  ...
  return (
    <div
      className={`${formStep === 5 ? "block" : "hidden"} flex flex-col gap-7`}
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex flex-row-reverse">
          <button
            className="text-xl font-bold bg-secondary shadow-lg shadow-secondary py-3 px-5 rounded-xl drop-shadow-md mt-7"
            type="submit"
          >
            Next
          </button>
...
export default TypeOfDeveloper;
